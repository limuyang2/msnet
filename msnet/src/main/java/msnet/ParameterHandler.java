...
abstract class ParameterHandler<T> {
    ...
    static final class Headers extends ParameterHandler<okcronet.http.Headers> {
        private final Method method;
        private final int p;
        ...
        @Override
        void apply(RequestBuilder builder, @Nullable okcronet.http.Headers headers) {
            if (headers == null) {
    ...
    static final class Part<T> extends ParameterHandler<T> {
        private final Method method;
        private final int p;
        private final okcronet.http.Headers headers;
        private final Converter<T, okcronet.http.RequestBody> converter;

        Part(Method method, int p, okcronet.http.Headers headers, Converter<T, okcronet.http.RequestBody> converter) {
            this.method = method;
            this.p = p;
        ...
        void apply(RequestBuilder builder, @Nullable T value) {
            ...
            okcronet.http.RequestBody body;
            try {
    ...
    static final class RawPart extends ParameterHandler<okcronet.http.MultipartBody.Part> {
        ...
        @Override
        void apply(RequestBuilder builder, @Nullable okcronet.http.MultipartBody.Part value) {
    ...
    static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        private final Method method;
        private final int p;
        private final Converter<T, okcronet.http.RequestBody> valueConverter;
        private final String transferEncoding;

        PartMap(
                Method method, int p, Converter<T, okcronet.http.RequestBody> valueConverter, String transferEncoding) {
            this.method = method;
            this.p = p;
            this.valueConverter = valueConverter;
        ...
        void apply(RequestBuilder builder, @Nullable Map<String, T> value) throws IOException {
            ...
            for (Map.Entry<String, T> entry : value.entrySet()) {
                ...
                okcronet.http.Headers headers =
                        okcronet.http.Headers.headersOf(
                                "Content-Disposition",
    ...
    static final class Body<T> extends ParameterHandler<T> {
        ...
        Body(Method method, int p, Converter<T, okcronet.http.RequestBody> converter) {
            this.method = method;
            this.p = p;
            this.converter = converter;
        }
