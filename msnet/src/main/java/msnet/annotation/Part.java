 ...
 *
 * <ul>
 *   <li>If the type is {@link MultipartBody.Part} the contents will be used directly. Omit
 *       the name from the annotation (i.e., {@code @Part MultipartBody.Part part}).
 *   <li>If the type is {@link RequestBody RequestBody} the value will be used directly with
